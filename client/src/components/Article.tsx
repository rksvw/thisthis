    ...
    <>
      <div className=" my-8 ml-14 w-[72%] self-center rounded-sm bg-[#fff] p-[25px]">
        <h1 className="my-5 self-center px-5 py-3 text-center text-4xl font-bold">
          If you think you can I know you can!
        </h1>
        ...
        <img
          src="https://img.freepik.com/free-photo/fuji-mountain-kawaguchiko-lake-sunset-autumn-seasons-fuji-mountain-yamanachi-japan_335224-1.jpg?t=st=1740646961~exp=1740650561~hmac=0ad76095edd042cddd3c5bf8d3396912bb44da0416f495ef2467bc0039f72c8e&w=1920"
          alt="Template"
        ...
        <div className="m-5 flex justify-between border-b-2 pb-5">
          ...
          <p className="text-[#808080]">
            Read:
            <span className="pl-2 font-mono font-semibold">2-min-50-sec</span>
          </p>
        </div>
        <div className="mx-auto my-10 w-4/5">
          <p className="flex items-center justify-center border-b-2 pb-5 text-start font-sans text-lg/7 text-[#252525]">
            {text}
          </p>
        </div>
      </div>
